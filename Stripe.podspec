Pod::Spec.new do |s|
  ...
  s.source                         = { :git => 'https://github.com/Angel-Studios/old-stripe-ios-do-not-use.git' }
  ...
  s.ios.resources                  = ['Stripe/Resources/**/*.png', 'Stripe/Resources/**/*.json', 'Stripe/Resources/**/*.lproj']
