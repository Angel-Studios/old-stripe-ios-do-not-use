  ...
  UITableViewDelegate
{
  ...
  @objc public convenience required init(theme: STPTheme?) {
    self.init(
      bankMethod: .FPX, configuration: STPPaymentConfiguration.shared, theme: theme ?? .defaultTheme
    )
  }
  ...
  public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
    ...
    {
      delegate?.bankSelectionViewController(self, didCreatePaymentMethodParams: paymentMethodParams)
    }
  }
...
@objc public protocol STPBankSelectionViewControllerDelegate: NSObjectProtocol {
  ...
  @objc(bankSelectionViewController:didCreatePaymentMethodParams:) func bankSelectionViewController(
